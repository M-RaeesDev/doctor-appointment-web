...
import { faDollarSign, faMoneyBill, faPerson } from '@fortawesome/free-solid-svg-icons';
...
export default function DoctorDetail({params}) {
    ...
    const Doctorlist = doctors.find((doctor) => doctor.id == params.id);
    return (
        <div className="min-h-screen">
            <section className="text-gray-600 body-font overflow-hidden">
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
    <div className="lg:w-1/2 w-full relative lg:h-auto h-64 object-cover object-center rounded ">

      <Image
        alt="doctor"
        fill = {true}
        src="https://images.unsplash.com/photo-1551601651-2a8555f1a136?q=80&w=1447&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
      />
    </div>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex justify-between my-2">
                              ...
                              <FontAwesomeIcon icon={faCalendarCheck} width={15} height={20} />
                                ...
                                <h1>{Doctorlist.appointmentTime}</h1>
                              </div>
                              <div className="flex justify-between my-2">
                              <div className="flex gap-2 items-center  ">
                                <FontAwesomeIcon icon={faMoneyBill} width={15} height={20} />
                                <h1 className="font-semibold">Fees</h1>
                                </div>
                                <h1>$ {Doctorlist.fees}</h1>
                              </div>
